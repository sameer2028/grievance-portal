  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <div>
        ...
        <p className="text-gray-500 text-sm mt-1">Real-time overview of all grievances</p>
      </div>
      ...
      {/* 7-day trend */}
      <div className="card">
        <h2 className="text-sm font-semibold text-gray-900 mb-4">Submissions — Last 7 Days</h2>
        {loadingSummary ? (
      ...
      <div className="card !p-0 overflow-hidden">
        <div className="px-5 py-4 border-b border-gray-200">
          <h2 className="text-sm font-semibold text-gray-900">Geographic Distribution</h2>
