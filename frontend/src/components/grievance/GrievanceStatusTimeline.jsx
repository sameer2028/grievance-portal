...
const STATUS_COLORS = {
  ...
  escalated:   'border-orange-400 bg-orange-50',
};
          ...
          <div key={idx} className="relative flex gap-4">
            ...
            <div
              className={`relative z-10 w-8 h-8 rounded-full border-2 flex items-center justify-center text-sm shrink-0 ${
                STATUS_COLORS[entry.status] || 'border-gray-300 bg-gray-50'
              }`}
            >
            ...
            <div className="flex-1 pb-6">
              ...
              <p className="text-xs text-gray-400 mt-1">{formatDate(entry.changedAt)}</p>
            </div>
          </div>
        );
      })}
